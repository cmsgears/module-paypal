...
INSERT INTO `cmg_core_model_meta` (`parentId`,`parentType`,`name`,`value`,`type`,`fieldType`,`fieldMeta`) VALUES
	...
	(1,'site','sb client id',null,'paypal-rest','password',null),
	(1,'site','sb secret',null,'paypal-rest','text',null),
	(1,'site','live client id',null,'paypal-rest','password',null),
	(1,'site','live secret',null,'paypal-rest','text',null);