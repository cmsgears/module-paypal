...
INSERT INTO `cmg_core_form_field` (`formId`,`name`,`label`,`type`,`compress`,`validators`,`order`,`icon`,`htmlOptions`,`data`) VALUES	
	(@form,'status','Status',80,0,'required',0,'icon','{\"title\":\"Status\",\"items\":[\"sandbox\",\"live\"]}',NULL),
	(@form,'payments','Payments',30,0,'required',0,NULL,'{\"title\":\"Payments Enabled\"}',NULL),
	(@form,'currency','Currency',80,0,'required',0,'icon','{\"title\":\"Currency\",\"items\":[\"USD\",\"CAD\"]}',NULL),
...
INSERT INTO `cmg_core_model_attribute` (`parentId`,`parentType`,`name`,`label`,`type`,`valueType`,`value`) VALUES
	...
	(@site,'site','payment enabled','Payments','paypal-rest','flag','0'),
	(@site,'site','currency','Currency','paypal-rest','text','USD'),
	(@site,'site','send address','Address','paypal-rest','flag','0'),
	(@site,'site','sb client id','Sandbox Client ID','paypal-rest','text',NULL),
	(@site,'site','sb secret','Sandbox Secret','paypal-rest','text',NULL),
	(@site,'site','live client id','Live Client ID','paypal-rest','text',NULL),
	(@site,'site','live secret','Live Secret','paypal-rest','text',NULL);